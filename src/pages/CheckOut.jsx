          ...
          <div className="col-md-6 p-2">
            ...
            <form className="row g-3 mb-3" onSubmit={handlePay}>
              ...
              <div className="col-12">
                ...
                <input type="text" id="inputAddress" className="form-control" required />
              </div>
              <div className="col-12">
                <label htmlFor="inputAddress2" className="form-label">Address 2</label>
                <input type="text" id="inputAddress2" className="form-control" placeholder="Apartment, studio, or floor" />
              </div>
              <div className="col-md-6">
                <label htmlFor="inputCity" className="form-label">City</label>
                <input type="text" id="inputCity" className="form-control" required />
              </div>
              ...
              <div className="col-md-2">
                ...
                <input type="text" id="inputZip" className="form-control" required />
              </div>
              <div className="col-12 mt-5">
                <button id="button-linker" type="submit" className="btn btn-primary">
                  Proceed To Pay
                </button>
              </div>
            </form>
